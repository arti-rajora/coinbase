...
ActiveRecord::Schema.define(version: 20180328122519) do
  ...
  create_table "usertaxes", force: :cascade do |t|
    t.integer  "user_id"
    ...
    t.datetime "created_at",                   null: false
    t.datetime "updated_at",                   null: false
    t.index ["user_id"], name: "index_usertaxes_on_user_id", using: :btree
    t.index ["wallet_id"], name: "index_usertaxes_on_wallet_id", using: :btree
  end
